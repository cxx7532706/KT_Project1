...
public class Main {
    ...
    public static void GEDrun() {
        try {
            ...
            FileReader fr = new FileReader("src/Analysis_table.txt");
    ...
    public static double Evaluation(String output) {
        ...
        try {
            ...
            FileWriter fw = new FileWriter("src/evaluation.txt");
            BufferedWriter bw = new BufferedWriter(fw);
    ...
    public static void Analyse(String file) {

        try {
            FileReader fr = new FileReader(file);
            BufferedReader br = new BufferedReader(fr);
            FileWriter fw = new FileWriter("src/Analysis_table.txt");
            BufferedWriter bw = new BufferedWriter(fw);
    ...
    //     GEDrun();
        double result = Evaluation("src/output3.txt");
        System.out.println(result);

        //double result = Evaluation("src/output1.txt");
        //System.out.println(result);

        //Analyse("src/evaluation.txt");
